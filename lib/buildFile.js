...
var path = require('path'),
    fs   = require('fs'),
    chalk = require('chalk'),
    mkdirRecursive = require('./utils/mkdirRecursive.js'),
 ...
 * @returns {null}
 */
async function buildFile(file = {}, platform = {}, dictionary = {}) {
  ...
  await new Promise((resolve) => {
    fs.writeFile(
      fullDestination, format(createFormatArgs({
